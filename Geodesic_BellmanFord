...
# Bellman-Ford algorithm using Geodesic distance method
bellman_ford_geodesic <- function(distance_matrix, start_node) {
...
main <- function() {
  ...
  start_time <- Sys.time()
  distances <- bellman_ford_geodesic(distance_matrix, start_node)
  end_time <- Sys.time()
